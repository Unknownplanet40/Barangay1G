...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/_root/pages/Reports/Reports.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/_root/pages/Reports/Reports.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************/
...
/* harmony import */ var _reports_BarChart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reports/BarChart.js */ "./resources/js/_root/pages/Reports/reports/BarChart.js");
/* harmony import */ var _reports_PieChart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reports/PieChart.js */ "./resources/js/_root/pages/Reports/reports/PieChart.js");
...
var barLabels = [];
var barBackgroundColors = ["red", "green", "gold", "orange", "blue", "brown", "purple", "crimson", "teal", "gray", "aqua", "lime", "wheat"];
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "Reports",
  components: {
    BarChart: _reports_BarChart_js__WEBPACK_IMPORTED_MODULE_0__["default"],
    PieChart: _reports_PieChart_js__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      breadcrumb: [{
  ...
  methods: {
    fetchAssistanceData: function fetchAssistanceData() {
      var _this = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return Object(_services_api__WEBPACK_IMPORTED_MODULE_2__["getAssistanceData"])();
            case 3:
              data = _context.sent;
              /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3476709828_172_16_172_33_4", data)));
              _this.assistanceCount = data.yearly.reduce(function (sum, item) {
                return sum + item.count;
              }, 0);
              _this.calculateAssistanceTotals(data);
              _this.prepareBarChartData(data);
              _context.next = 13;
              break;
            case 10:
              _context.prev = 10;
              _context.t0 = _context["catch"](0);
              _this.errors = _context.t0.message;
            case 13:
            case "end":
    ...
    calculateAssistanceTotals: function calculateAssistanceTotals(data) {
      var _console2;
      var currentYear = new Date().getFullYear();
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3476709828_185_12_185_29_4", data)));
      var currentMonth = new Date().getMonth() + 1; // getMonth() is zero-based
      var currentWeek = this.getWeekNumber(new Date());
      var yearlyData = data.yearly.find(function (item) {
        return item.year === currentYear;
      });
      var monthlyData = data.monthly.find(function (item) {
        return item.month === currentMonth;
      });
      var weeklyData = data.weekly.find(function (item) {
    ...
    prepareBarChartData: function prepareBarChartData(data) {
      var labels = [];
      var dataset = [];
      data.monthly.forEach(function (item) {
        var month = new Date(0, item.month - 1).toLocaleString("default", {
          month: "short"
        });
        labels.push(month);
    ...
    submitReport: function submitReport() {
      ...
      /* eslint-disable */
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3476709828_242_12_242_57_4", "Report submitted:", this.report)));
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/_root/pages/Reports/Reports.vue?vue&type=template&id=583f5508&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/_root/pages/Reports/Reports.vue?vue&type=template&id=583f5508&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************************/
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      submit: function submit($event) {
        ...
        return _vm.submitReport.apply(null, arguments);
      }
    }
  }, [_c("div", {
  ...
  }, [_c("p", [_vm._v("\n                                    Total Assistance: " + _vm._s(_vm.assistanceCount) + "\n                                ")]), _vm._v(" "), _c("p", [_vm._v("\n                                    Total Assistance This Year:\n                                    " + _vm._s(_vm.assistancePerYear) + "\n                                ")]), _vm._v(" "), _c("p", [_vm._v("\n                                    Total Assistance This Month:\n                                    " + _vm._s(_vm.assistancePerMonth) + "\n                                ")]), _vm._v(" "), _c("p", [_vm._v("\n                                    Total Assistance This Week:\n                                    " + _vm._s(_vm.assistancePerWeek) + "\n                                ")])]), _vm._v(" "), _c("BarChart", {
