                    ...
                    <b-col cols="6">
                        <b-form-group label="Longitude">
                            <b-form-input
                                ...
                                type="number"
                                step="any"
                                :class="errors.lng ? 'is-invalid' : ''"
                            ></b-form-input>
                            <div class="invalid-feedback" v-if="errors.lng">
                                {{ errors.lng[0] }}
                            </div>
                        </b-form-group>
                    </b-col>
    ...
    methods: {
        ...
        initMap() {
            this.map = L.map("map").setView(
                [this.assistant.lat, this.assistant.lng],
                13
